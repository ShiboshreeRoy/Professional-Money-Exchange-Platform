...
<body>
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs" id="adminTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="users-tab" data-bs-toggle="tab" data-bs-target="#users_management" type="button" role="tab">Users</button>
            </li>
        ...
        <div class="tab-content mt-3">
            ...
            <!-- For brevity, I'm only including the cards tab with enhanced features -->
